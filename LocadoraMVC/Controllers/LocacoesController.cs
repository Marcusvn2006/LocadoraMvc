...
namespace LocadoraMVC.Controllers
{
    public class LocacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataLocacao,DataDevolucao,VeiculoId,ClienteId")] Locacao locacao)
        {
            ...
            ViewData["VeiculoId"] = new SelectList(_context.Veiculo, "Id", "Modelo", locacao.VeiculoId);
            return View(locacao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,DataLocacao,DataDevolucao,VeiculoId,ClienteId")] Locacao locacao)
        {
            if (id != locacao.Id)
            {
                return NotFound();
